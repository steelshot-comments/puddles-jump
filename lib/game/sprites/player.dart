...
class PlayerSprite extends SpriteGroupComponent<PlayerState>
  ...
  void onCollision(Set<Vector2> intersectionPoints, PositionComponent other) {
    ...
    bool isCollidingVertically =
        (intersectionPoints.first.y - intersectionPoints.last.y).abs() < size.y;
    ...
    if (isMovingDown && isCollidingVertically) {
      ...
      if (other is NormalPlatform) {
        ...
        jump(specialJumpSpeed: jumpSpeed * 1.5);
        return;
  ...
  Future<void> _loadCharacterSprites() async {
    ...
    final left = await gameRef.loadSprite('game/left@2x.png');
    final right = await gameRef.loadSprite('game/right@2x.png');
    final center = await gameRef.loadSprite('game/center@2x.png');
    final rocket = await gameRef.loadSprite('game/rocket_4.png');
    final nooglerCenter = await gameRef.loadSprite('game/center@2x.png');
    final nooglerLeft = await gameRef.loadSprite('game/left@2x.png');
    final nooglerRight = await gameRef.loadSprite('game/right@2x.png');
